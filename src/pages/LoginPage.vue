        ...
        <v-layout align-center justify-center>
          <v-flex xs12 sm8 md4>
            <v-card class="elevation-12">
              <v-toolbar dark color="amber lighten-2">
                <v-img
                  alt="Vuetify Logo"
                  class="shrink mr-2"
                  contain
                ...
                <v-spacer></v-spacer>
                <v-toolbar-title>
                  <h2 class="red--text text--darken-1">Авторизация</h2>
                </v-toolbar-title>
              </v-toolbar>
              <v-card-text>
                <v-form>
                  <v-row>
                    <v-icon class="pl-3 pr-3" color="deep-orange accent-3"
                      >mdi-account</v-icon
                    >
                    <v-text-field
                      v-model="username"
              ...
              <v-card-actions>
                ...
                <v-btn @click="signIn" color="amber lighten-2">
                  <v-icon class="pr-1" color="deep-orange accent-3" large
